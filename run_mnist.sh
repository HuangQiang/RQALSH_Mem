...
#  Linear Scan
# ------------------------------------------------------------------------------
./rqalsh -alg 1 -n ${n} -qn ${qn} -d ${d} -ds ${dPath}.ds -qs ${dPath}.q \
    -ts ${dPath}.fn${c} -op ${oPath}

# ------------------------------------------------------------------------------
#  QDAFN
# ------------------------------------------------------------------------------
./rqalsh -alg 2 -n ${n} -qn ${qn} -d ${d} -L 0 -M 0 -c ${c} -ds ${dPath}.ds \
...
do 
    ...
    ./rqalsh -alg 3 -n ${n} -qn ${qn} -d ${d} -L ${L} -M ${M} -ds ${dPath}.ds \
        -qs ${dPath}.q -ts ${dPath}.fn${c} -op ${oPath}
done
...
#  RQALSH
# ------------------------------------------------------------------------------
./rqalsh -alg 4 -n ${n} -qn ${qn} -d ${d} -c ${c} -ds ${dPath}.ds \
    -qs ${dPath}.q -ts ${dPath}.fn${c} -op ${oPath}
...
do 
    ...
    ./rqalsh -alg 5 -n ${n} -qn ${qn} -d ${d} -L ${L} -M ${M} -c ${c} \
...
#  ML_RQALSH
# ------------------------------------------------------------------------------
./rqalsh -alg 6 -n ${n} -qn ${qn} -d ${d} -c ${c} -ds ${dPath}.ds \
    -qs ${dPath}.q -ts ${dPath}.fn${c} -op ${oPath}
